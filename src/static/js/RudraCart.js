...
var cartModule = (function () { // namespace
    ...
    var cart = {
        ...
        addToCart : function () { // Добавляем товар в корзину
            ...
            setTimeout(function(){
                cart.getCheckout().innerHTML = '<p class="spis-num">' + parseInt(localStorage.getItem('RudraJS-Cart::count')) + '</p>';
            }, 1000);
        },
        ...
        openCart : function () {
            ...
            if(Object.keys(data).length !== 0){
                ...
                cart.getContent().innerHTML = ''
                    ...
                    + '<tr><th>Артикул</th><th>Наименование</th><th>Цена</th><th>Количество</th><th></th></tr>'
                    + item
                    +'<tr><td></td><td>Общая сумма:</td><td class="all_price">' + price + '</td><td class="all_count">' + count + '</td><td><button id="clear_cart" class="btn btn-default" style="color: red">Очистить список</button></td></tr>'
                    + '</table>';
                ...
                cart.getCheckout().innerHTML = '<p class="spis-num">0</p>'; /* в корзине пусто */
                cart.getContent().innerHTML  = ''
            }
        },
        ...
        clearCart : function () {
            cart.getContent().innerHTML  = '';
            cart.getCheckout().innerHTML = '<p class="spis-num">0</p>';
            localStorage.clear();
        ...
        checkout : function () {
            this.getCheckout().innerHTML = '<p class="spis-num">' + parseInt(localStorage.getItem('RudraJS-Cart::count')) + '</p>';
        },
