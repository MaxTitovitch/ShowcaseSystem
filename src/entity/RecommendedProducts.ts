...
// @Index("RECOMMENDED_PRODUCTS_UNIQUE", ["categoryId", "productId"], { unique: true })
@Entity("RECOMMENDED_PRODUCTS")
export class RecommendedProducts {
  @Column("number", {primary: true, name: "CATEGORY_ID", precision: 10, scale: 0})
  categoryId: number;

  @Column( { type: 'long', name: "RECOMMENDED_PRODUCTS"})
